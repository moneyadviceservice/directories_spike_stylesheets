    ...
    <>
      <div class="l-contact-panels">
        <div class="l-contact-panel contact-panel__dynamic-content">
          <div
            class="contact-panel contact-panel__chat-open t-chat"
            id="js-chat"
          >
            ...
            <div
              class="contact-panel__dynamic-content is-loaded"
              id="js-chat-content"
            >
              <div class="contact-panel__preloader"></div>
              <p
                class="contact-panel__chat-description t-chat-description"
                id="js-chat-description"
              >
                Got a question? Our advisers will point you in the right
                direction.
              </p>
            </div>
            ...
            <div class="contact-panel__button-container" id="js-chat-cta">
              <a
                class="contact-panel__button button t-chat-button"
                href="https://webchat.moneyadviceservice.org.uk/newchat/chat.aspx?domain=www.moneyadviceservice.org.uk&amp;timestamp=1583760521529&amp;session=871-1574174297541?domain=www.moneyadviceservice.org.uk&amp;timestamp=1583760552334&amp;session=871-1574174297541"
                target="_blank"
              >
                Launch chat
              </a>
            ...
            <p class="contact-panel__chat-javascript t-chat-javascript">
              ...
              <a href="http://www.enable-javascript.com/">
                internet browsers with JavaScript
              </a>
              .
            </p>
          </div>
        ...
        <div class="l-contact-panel contact-panel__dynamic-content contact-panel__whatsapp">
          <div class="contact-panel contact-panel__chat-open" id="js-whatsapp">
            ...
            <div
              class="contact-panel__dynamic-content is-loaded"
              id="js-whatsapp-content"
            >
              <ul
                class="contact-panel__chat-description contact-panel__list unstyled-list"
                id="js-whatsapp-description"
              >
                <li class="contact-panel__additional-info">
                  <p>
                    Need help sorting out your debts, have credit questions or
                    want pensions guidance? Add +44 7701 342744 to your Whatsapp
                    and send us a message.
                  </p>
                </li>
                <li class="contact-panel__additional-info">
                  <p>
                    For everything else please contact us via Webchat or
                    Telephone.
                  </p>
                </li>
              </ul>
              ...
              <div class="contact-panel__button-container">
                <a
                  class="contact-panel__button button t-whatsapp-button"
        ...
        <div class="l-contact-panel contact-panel__dynamic-content">
          <div class="contact-panel contact-panel--last">
            <h2
              aria-level="2"
              class="contact-panel__heading t-contact-heading"
              role="heading"
            >
            ...
            <ul class="contact-panel__list">
              <li class="t-contact-introduction contact-panel__additional-info contact-panel__contact-introduction">
                Give us a call for free and impartial money advice.
              </li>
              <li class="contact-panel__additional-info">
                <p class="contact-panel__contact-number">
                  <a
                    class="contact-panel__telephone t-contact-number"
                    href="tel:+448001387777"
                  >
                    0800 138 7777
                  </a>
                </p>
              ...
              <li class="contact-panel__additional-info">
                <p>
                  ...
                  <a href="mailto:enquiries@maps.org.uk">
              ...
              <li class="contact-panel__additional-info">
                <div class="contact-panel__button-container">
                  <a
                    class="contact-panel__button button"
              ...
              <li class="contact-panel__additional-info">
                <p>
                  We will normally respond to your enquiry within 48 hours of
                  receipt.
                </p>
              </li>
            </ul>
              ...
              <ul class="l-footer-primary__social-sharing t-footer-social-links">
                <li class="l-footer-primary__list--left">
                  <div class="footer-primary__list-item">
                    <a
                      class="button facebook-link t-facebook-link"
                      lang="en"
                      href="https://www.facebook.com/MoneyAdviceService?ref=mas"
                      target="_blank"
                    >
                ...
                <li class="l-footer-primary__list--centre">
                  <div class="footer-primary__list-item">
                    <a
                      class="button twitter-link t-twitter-link"
                      lang="en"
                      href="https://twitter.com/YourMoneyAdvice"
                      target="_blank"
                    >
                    ...
                    <p class="social-sharing__counter">
                      ...
                      <span class="social-sharing__counter__label">
                        Followers
                      </span>
                    </p>
                  </div>
                ...
                <li class="l-footer-primary__list--right">
                  <div class="footer-primary__list-item">
                    <a
                      class="button youtube-link t-youtube-link"
                      lang="en"
                      href="https://www.youtube.com/user/MoneyAdviceService"
                      target="_blank"
                    >
              ...
              <nav role="navigation" aria-label="footer">
                <ul class="l-footer-primary__list">
                  <li class="footer-primary__list-item footer-primary__corporate-link">
                    <a href="https://www.moneyadviceservice.org.uk/en/static/about-us">
                      About us
                    </a>
                  </li>
                  <li class="footer-primary__list-item footer-primary__corporate-link">
                    <a href="https://www.moneyadviceservice.org.uk/en/categories/our-debt-work">
                      Our debt work
                    </a>
                  </li>
                  <li class="footer-primary__list-item footer-primary__corporate-link">
                    <a href="https://www.moneyadviceservice.org.uk/en/static/media-centre">
                      Media centre
                    </a>
                  </li>
                  <li class="footer-primary__list-item footer-primary__corporate-link">
                  ...
                  <li class="footer-primary__list-item footer-primary__corporate-link">
                    <a href="https://www.moneyadviceservice.org.uk/en/categories/partners">
                      Partners
                    </a>
                  </li>
                  <li class="footer-primary__list-item footer-primary__corporate-link">
                    <a href="https://www.moneyadviceservice.org.uk/en/static/jobs">
                      Jobs
                    </a>
                  </li>
                  <li class="footer-primary__list-item footer-primary__corporate-link">
                    <a href="https://www.moneyadviceservice.org.uk/en/categories/tools-and-calculators">
                      Tools &amp; calculators
                    </a>
                  </li>
                </ul>
                ...
                <div class="footer-primary__blog">
                  <a
                    target="_blank"
                    class="footer-primary__blog-link"
                    href="https://blog.moneyadviceservice.org.uk"
                  >
                    Blog
                  </a>
                </div>
                  ...
                  >
                    ...
                    <span class="visually-hidden">
                      ...
                      <span
                        ...
                        title="translation missing: en.footer.new-window-label"
                      >
                        New Window Label
                      </span>
                    </span>
              ...
              <div class="l-footer-secondary__list--left">
                <ul class="l-footer-secondary__list">
                  <li class="l-footer-secondary__list-item  l-language-link">
                    <a
                      class="t-cy-link"
                      href="https://www.moneyadviceservice.org.uk/cy/empty"
                      lang="cy"
                    >
                  ...
                  <li class="l-footer-secondary__list-item accessibility-feedback-link">
                    <a
                      ...
                      target="_blank"
                    >
                      <span class="icon icon--accessibility"></span>Report an
                  ...
                  <li class="l-footer-secondary__list-item footer-secondary__mps-link">
                    <a
                      href="https://moneyandpensionsservice.org.uk/"
                      target="_blank"
                    >
              ...
              <div class="l-footer-secondary__list--right">
                <ul class="l-footer-secondary__list">
                  <li class="l-footer-secondary__list-item footer-secondary__link-item">
                    <a href="https://www.moneyadviceservice.org.uk/en/static/contact-us">
                      Contact us
                    </a>
                  </li>
                  <li class="l-footer-secondary__list-item footer-secondary__link-item">
                    <a href="https://www.moneyadviceservice.org.uk/en/static/terms-and-conditions">
                      Terms &amp; conditions
                    </a>
                  </li>
                  <li class="l-footer-secondary__list-item footer-secondary__link-item">
                    <a href="https://www.moneyadviceservice.org.uk/en/corporate/privacy">
                      Privacy notice
                    </a>
                  </li>
                  <li class="l-footer-secondary__list-item footer-secondary__link-item">
                    <a href="https://www.moneyadviceservice.org.uk/en/static/accessibility">
                      Accessibility
                    </a>
                  </li>
                  <li class="l-footer-secondary__list-item footer-secondary__link-item">
                    <a href="https://www.moneyadviceservice.org.uk/en/static/cookie_notice_en">
                      Cookies
                    </a>
                  </li>
                  <li class="l-footer-secondary__list-item footer-secondary__link-item">
                    <a href="https://www.moneyadviceservice.org.uk/en/sitemap">
                      Sitemap
                    </a>
                  </li>
                </ul>
